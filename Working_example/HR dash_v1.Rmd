...
americas=read_excel("Regional files/HR Dashboard_v1 - Americas.xlsx", sheet = "data")

apac=read_excel("Regional files/HR Dashboard_v1 - APAC.xlsx",sheet = "data")

europe=read_excel("Regional files/HR Dashboard_v1 - Europe.xlsx",sheet = "data")
...
valueBox(value = netchange,icon = "fa-arrow-down",caption = "Net Change", color = "blue")}
...
# Bar chart:
# h5 %>% 
#   ggplot(aes(x = `Employment type`,
#              y = count, fill = `Employment type`)) + geom_col()
# ggplotly()

plot_ly(h5,
        x= h5$`Employment type`,
        y = h5$count,
        color = h5$`Employment type`,
        type = "bar")
...
Change pie chart to a bar chart
