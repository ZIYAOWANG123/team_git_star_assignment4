...
```{r Q1,echo=TRUE,fig.width=8,fig.height=15,fig.cap="Top 10 Suburb with most incidents recorded"}
data3 %>% 
...
```
The Figure \@ref(fig:Q1) 


## What were the top 10 Offence's in each year ?

```{r Q2,echo=FALSE,fig.width=8,fig.height=15,fig.cap="Top 10 Offences recorded"}
data3 %>% 
...
Q3graph <- data3 %>% 
  ...
  ggplotly(Q3graph)
```
## What is the trend of top 2 offences in each year w.r.t most common Suburb?

```{r Q4,fig.width=10,fig.height=10,Fg.cap="Trend of Top 2 Offences in each year w.r.t Suburb" }
Q4graoh <- data3 %>% 
  filter(Suburb %in% unique(Suburb_imp$Suburb)) %>% 
